...
class MyCaptainDataTable extends BaseDataTable {
    ...
    public function query() {
        return Captain::query()->with(['callcenter', 'images', 'car', 'scooters', 'tricycles'])->where('captain_id', get_user_data()->id)->whereCountryId(get_user_data()->country_id)->latest();
    }
